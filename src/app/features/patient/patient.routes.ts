...
export const PATIENT_ROUTES: Routes = [
  ...
  {
    path: 'dashboard',
    loadComponent: () => import('./dashboard/dashboard').then((m) => m.PatientDashboard),
  },
  {
    path: 'medication',
    loadComponent: () => import('./medication/medication').then((m) => m.Medication),
  },
  {
    path: 'profile',
    loadComponent: () => import('./profile/profile').then((m) => m.PatientProfile),
  },
  {
